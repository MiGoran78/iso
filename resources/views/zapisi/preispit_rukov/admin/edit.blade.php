        ...
        <div class="col-md-9" style="margin: 0px; padding: 0px; padding-top: 15px">
            <div class="panel panel-primary" style="margin-bottom: 0px">
                <div class="panel-heading" style="padding-bottom: 4px; padding-top: 4px">
                    <b>U.POR.ZPR &nbsp;- &nbsp;Preispitivanje od strane rukovodsta, ciljevi kvaliteta</b>&nbsp;&nbsp;[Izmena zapisa]
                </div>
                        ...
                        <div style="padding-bottom: 5px">
                            <div class="row" style="">
                                ...
                                <div class="col-md-4" style="padding-left: 0px">
                                    {!! Form::text('datum', $datas->datum, ['class'=>'form-control', 'style'=>'width:130px; height: 28px; text-align: center', 'placeholder'=>'']) !!}
                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row" style="padding-bottom: 2px">
                                                        <div class="col-md-12" style="margin-top: 3px">
                                                            {!! Form::textarea('ciljevi_izvestaj', $datas->ciljevi_izvestaj, ['style'=>'resize: vertical; width:100%', 'rows'=>'15', 'placeholder'=>'...']) !!}
                                                        </div>
                                                    </div>

                                                    <div class="row" style="padding-bottom: 2px">
                                                        <div class="col-md-4" style="padding-top: 10px">
                                                            {!! Form::text('odobrio_datum', $datas->odobrio_datum, ['style'=>'width:100%; text-align:center', 'placeholder'=>'datum odobrenja']) !!}
                                                        </div>
                                                        <div class="col-md-1" style="padding-top: 10px"></div>
                                                        <div class="col-md-7" style="padding-top: 10px">
                                                            {!! Form::text('odobrio_ime', $datas->odobrio_ime, ['style'=>'width:100%; text-align:center', 'placeholder'=>'odobrio']) !!}
                                                        </div>
                                                    </div>
